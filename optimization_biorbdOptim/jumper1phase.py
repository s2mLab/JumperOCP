...
def prepare_ocp(
    ...
    constraints.add(CoM_dot_Z_last_node_positivity, phase=0, node=Node.END, min_bound=0, max_bound=np.inf)
    constraints.add(Torque_Constraint, phase=0, node=Node.ALL)
